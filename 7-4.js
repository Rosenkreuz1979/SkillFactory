...
ElectricalApp.prototype.switchOn = function() {
    switch (this.state) {
    case "off":
...
ElectricalApp.prototype.switchOff = function() {
    switch (this.state) {
    case "off":
...
function HomeAppliance (name,power) {
    this.name = name,
    this.power = power
}

HomeAppliance.prototype = new ElectricalApp();

function GamingAppliance (name,brand,power) {
    this.name = name,
    this.brand = brand,
    this.power = power
}

GamingAppliance.prototype = new ElectricalApp();
